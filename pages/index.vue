...
<template>
  <div class="max-w-4xl mx-auto p-6 bg-gray-100">
    ...
    <div class="md:flex justify-between items-center mb-8">
      <div>
        <h1 class="text-3xl font-bold mb-2">LocalhostDump</h1>
        <p class="text-gray-600">Where abandoned projects find new life</p>
      </div>
      <button 
    ...
    <div class="mb-6 flex flex-col md:flex-row gap-4">
      ...
      <div class="flex-grow relative">
        ...
        />
        <Icon name="lucide:search" class="absolute left-3 top-3 text-gray-400 w-5 h-5" />
      </div>
    ...
    <!-- Projects List -->
    <div v-if="filteredAndSortedProjects.length" class="space-y-4">
      <ProjectCard
    ...
    <div v-else class="text-center py-8 text-gray-500">
      <Icon name="lucide:folder-open" class="mx-auto mb-4 w-12 h-12" />
